                    ...
                    <header className="navbar">
                        <nav>
                            ...
                            <div className="bottom">
                                <ul className="drop-menu">
                                    <li> <button type="button" className="btn-sm button btn btn-primary buttons-left" data-toggle="modal" data-target="#myModal" onClick={this.focus.bind(this)}>Trade</button></li>
                                    <li> <button type="button" className="btn-sm button2 btn btn-primary buttons-left"onClick={this.props.deleteOrders}>Delete All</button></li>
                                    <li> <button type="button" className="btn-sm button2 btn btn-primary buttons-left" onClick={this.props.refreshData}>Refresh</button></li>
                                    <li className="pull-right "> <button className="icon chart btn btn-sm btn-primary buttons-right" onClick={this.props.openChart}> <i className="fa fa-bar-chart" aria-hidden="true"></i></button></li>
                                    <li className="pull-right"> <button className="icon btn btn-sm btn-primary button2 buttons-right" onClick={this.props.openTable} > <i className="fa fa-table" aria-hidden="true"></i></button></li>
                                </ul>
                            </div>
                        </nav>
                    </header>
